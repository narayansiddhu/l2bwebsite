...
$sms_details=  $this->fetch_sms_details();
        ...
        ?><script>
        window.location.href = "<?php echo base_url() ?>index.php/exams/results/" +<?= $examid ?> +"?section=<?php echo $section ?>";
        </script>
            <?php
                             ...
                             $subjects_marks_html.='<tr>
                                             <td width="13%">'.strtoupper($sub->subject).'</td>
											  <td width="13%">'.$sm.'</td>
											   <td width="13%">'.$fm.'</td>
                                            <td width="13%">'.$gra.'</td>
                                            <td width="13%">'.number_format((($total/$sub->maxmarks)*100)/10,1).'</td>
                                        </tr>';
                         }
