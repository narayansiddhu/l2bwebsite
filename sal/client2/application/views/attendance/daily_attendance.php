        ...
        <div class="box">
            <div class="breadcrumbs">
                    <ul>
                        ...
                        <li>
                            <a href="">Add Student Attendance </a>
                        </li>
                    </ul>
            </div> 
            <?php
            ...
            <?php 
              if((strlen($date)==0)||(strlen($slot)==0)){
                  ?>    
                        ...
                        <div class="box-title">
                                <h3><i class="fa fa-check" aria-hidden="true"></i>Add Attendance</h3> 
                        </div>
                        <div class="box-content nopadding "  >
                            <form class='form-horizontal form-bordered' action="" method="post" enctype="multipart/form-data"  >
                                ...
                                <div class="col-sm-6 nopadding" style=" padding-left: 10px;">
                                    <div class="form-group">
                                            <label for="textfield" class="control-label col-sm-2">Slot</label>
                                            <div class="col-sm-10">
                                                <select onchange="check_date_slot();"  onselect="check_date_slot();" id="slot" name="slot" class="select2-me" style=" width: 100%; height: 33px;"> 
                            ...
                            <?php
                              if(isset($_GET['month'])&&isset($_GET['year'])){
                                  $day= mktime(0, 0, 0, $_GET['month'], 1, $_GET['year']); 
                                  $day = getdate($day);
                              }else{
                                    $day = getdate();
                              }
                        ...
                        <div class="box-title">
                                <h3><i class="fa fa-check" aria-hidden="true"></i>Attendance Dates & Slots</h3> 
                                <div class="actions"><form>
                                    
                                    
                                    <select class="select2-me" id="att_month" name="month"  style=" width:100px; ; float: left"  >
                                    ...
                                    <select class="select2-me" id="att_year" name="year"  style=" width:100px; ; float: left"  >
                                    ...
                                    <button style=" float: left; width: 15px; color: whitesmoke" class="btn btn-primary"><i class="fa fa-search"></i></button>
                                </form>
                                </div>
                        </div>
                        <div class="box-content nopadding " style="max-height: 350px; overflow-y: scroll" >
                            <table class="table table-bordered table-striped ">
                                ...
                                <tbody >
                                    ...
                                    $q=$this->db->query("SELECT day, count(*) , GROUP_concat(DISTINCT(slot)) as slots FROM `attendance_date` where iid='".$this->session->userdata("staff_Org_id")."'  AND day >='".$from."' AND day <'".$to."'  GROUP BY day ");
                                    
                                    $q = $q->result();$i=1;$a=0;
                                    foreach ($q as $value) {
                                        $slots=explode(",",$value->slots);
                                        ?>
                                    <tr>
                                        <td><?php echo $i++; ?></td>
                                        <td><a  rel="tooltip" title="" data-original-title="View <?php echo date("d-m-y",$value->day); ?> Attendance Report" target="_blank" href="<?php echo base_url() ?>index.php/attendance/view?dtcls_name=&att_date=<?php echo date("d/m/y",$value->day);  ?>"><?php echo date("d-m-y",$value->day); ?></a></td>
                                        <td><?php  if(in_array("1",$slots)){
                                            $a++;
                                                ?>
                                            <a href="<?php echo base_url() ?>index.php/attendance/add_attendance?date=<?php echo date("d/m/Y",$value->day); ?>&slot=1#">Edit</a>
                                                   <?php
                                               } else{
                                            ?>       
                                            <a href="<?php echo base_url() ?>index.php/attendance/add_attendance?date=<?php echo date("d/m/Y",$value->day); ?>&slot=1#">Add</a>
                                             <?php
                                            }
                                            ?></td>
                                        <td><?php  
                                            if(in_array("2",$slots)){$a++;
                                                ?>
                                            <a href="<?php echo base_url() ?>index.php/attendance/add_attendance?date=<?php echo date("d/m/Y",$value->day); ?>&slot=2#">Edit</a>
                                                   <?php
                                               } else{
                                            ?>       
                                            <a href="<?php echo base_url() ?>index.php/attendance/add_attendance?date=<?php echo date("d/m/Y",$value->day); ?>&slot=2#">Add</a>
                                             <?php
                                            }
                                            ?></td>
                        ...
                        <div class="box-content  ">
                            <h5 style=" text-align: center;  font-size: 18px;margin: 0px;">Slots : <?php echo ($i-1)*2 ?>  Added : <?php echo $a ?>   Remaining : <?php echo (($i-1)*2)-$a ?> </h5>
                         </div>
                    </div>
                            </div>
                        </div>
                ...
                foreach($query as $val){
                    ...
                    $sections .=$val->sid.",";
                    $section_array[$val->sid] = array("id"=>$val->sid ,'section'=>$val->secname,'cls_name'=>$val->cls_name);
                }
                ...
                ?>
                       <div class="box "   >
                                    ...
                                    <div class="box-content nopadding " style=" min-height: 300px;"  > 
                                        ...
                                        <div class="row">
                                            <div class="col-sm-9 ">
                                                <input type="hidden" name="section_dat_info" value='<?php echo  json_encode($section_array) ?>' />
                                                            ...
                                                            <tbody> 
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td id="td_action_<?php echo $stud->student_id  ?>">
                                                                        <input type="checkbox" name="stud_<?php echo $stud->student_id ?>" id="stud_<?php echo $stud->student_id ?>" onclick="add_absent_list('<?php echo $val['secid'] ?>','<?php echo $stud->student_id ?>','<?php echo $stud->roll ?>');" value="" <?php
                                                                        if(array_key_exists($stud->student_id, $absenties)){
                                                                          echo ' checked="" ';  
                                                                        }
                                                                        ?> />
                                                                       ...
                                                                       $student_list[$stud->roll] = array('student_id'=>$stud->student_id ,'name'=>$stud->name,'phone'=>$stud->phone,'roll'=>$stud->roll ,'userid' => $stud->userid);
                                                                     }
                                                                   }
                            ...
                            ?>
                                            ...
                                            <?php
                                            $msg ="Dear parent,\nYour ward was absent today i.e ".date("d-m-Y",$day);
                                             ...
                                             if($msg_ids->num_rows()>0){
                                                $msg_ids =$msg_ids->row();
                                                $msg =$msg_ids->msg_content;
                                             }
                                            ?>
                                            <div class="col-sm-3 " style=" padding-left: 10px;" >
                                                <div class="box" style=" padding-left: 8px;">
                                                    <h4 style=" color: blue"><i class="fa fa-comments-o" aria-hidden="true"></i>SMS 
                                                    </h4>
                                                    <table class="table">
                                                        <tr>
                                                            <td colspan="2">Send SMS &nbsp;<input type="checkbox" name="send_sms" value="1" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" style=" vertical-align: top ">Message</td>
                                                            </tr>
                                                        <tr>
                                                            <td colspan="2">
                                                                <textarea style=" width: 100%; resize: none" id="alert_message" name="alert_message" rows="5" class="form-control" placeholder="Enter Message content"><?php 
                                                                if(strlen(trim($this->form->value("alert_message"))) >0 ){
                                                                    echo $this->form->value("alert_message");
                                                                }else{
                                                                    echo  $msg;
                                                                }
                                                    ...
                                                    foreach($this->form->errors as $val){
                                                       ?>
                                                    <span style=" color: red"><?php echo $val ?></span>
                                                       <?php 
                                                    }
                                                    //  print_r($this->form->errors);
                                                    ?>
                                                </div>
                                            </div>
                                        </div>
