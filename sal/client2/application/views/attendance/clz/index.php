            ...
            <div class="box"><br/>
                <div class="col-sm-6 nopadding " style="border-right: 2px solid #318EE0">
                    ...
                    <div class="col-sm-6" style=" float: left" >
                           <a style=" float: right " class="new_title" href="<?php echo base_url(); ?>index.php/staff/Monthly_attendance"  style=" text-decoration: none !important;" >
                                <i class="fa fa-file-text-o fa-2x"></i>
                                <p>Reports</p>
                            </a> 
                           <a style=" float: right " class="new_title" href="<?php echo base_url(); ?>index.php/staff/attendance"  style=" text-decoration: none !important;" >
                    ...
                    <?php
                    // select d.id,d.day,count(*)as counter from staff_attendance_date d JOIN staff_attendance a ON a.date_id=d.id where d.iid=33 AND a.status=1 GROUP BY d.id  ORDER BY d. day DESC LIMIT 0,5;
        ...
        series: [{
            ...
            data: [<?php echo $avg ?>]
                ...
                <div class="col-sm-6 nopadding" style=" padding-left: 10px;" >
                    ...
                    <div class="col-sm-6" >
                            <a class="new_title" href="<?php echo base_url(); ?>index.php/Clzattendance/add_attendance"  style=" text-decoration: none !important;" >
                                <i class="fa fa-plus fa-2x"></i>
                                <p>Add</p>
                            </a>
                           <a class="new_title" href="<?php echo base_url(); ?>index.php/Clzattendance/view"  style=" text-decoration: none !important;" >
                                <i class="fa fa-cogs fa-2x"></i>
                                <p>Settings</p>
                            </a>
                            <a class="new_title" href="<?php echo base_url(); ?>index.php/Clzattendance/reports"  style=" text-decoration: none !important;" >
                                <i class="fa fa-file-text-o fa-2x"></i>
                                <p>Reports</p>
                            </a>
                    ...
                    <div class="box">
                        <br/><br/><br/><br/><br/><br/>
                        <h4 style=" color: red; width: 100%; text-align: center; margin-top: 45px">** No Attendance Records Found..</h4>
                    </div>
                         <?php
                    }else{
                         $dates="";$avg="";
