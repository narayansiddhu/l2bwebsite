           ...
           <?php
              if($show_details==1){
                    ...
                    <div class="box box-bordered box-color">
                            ...
                            <div class="box-content nopadding">                                
                                <form class='form-horizontal form-bordered' action="<?php echo base_url(); ?>index.php/exams/savesettings" method="post" enctype="multipart/form-data"  >
                                    ...
                                    <td>
                                        ...
                                        <td>
                                           ...
                                           $end_time ="";
                                            ...
                                            <input <?php
                                          if(strlen($this->form->error('ending_'.$value->cid))>0 ){
                                                 echo  ' style="border:1px solid #FF0000"';
                                          }
