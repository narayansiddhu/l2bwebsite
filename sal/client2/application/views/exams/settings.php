                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <td>
                                          ...
                                          ?>  placeholder="Cut-off Marks"  name="min_<?php echo $value->cid ?>" min="0" class="form-control" value="<?php
                                        if(strlen($this->form->value('min_'.$value->cid))>0 ){
                                                  echo $this->form->value('min_'.$value->cid);
                                                }else{
                                                  if(isset($exam_settings[$value->sid])){
                                                       echo $exam_settings[$value->sid]['minmarks'];
                                                    }
                                                }?>"  /></td>
                                </tr>
                                      <?php
