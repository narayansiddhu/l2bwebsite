        ...
        <div class="box">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>index.php/Admissions/pending">Pending Admissions</a>
                         <i class="fa fa-angle-right" aria-hidden="true"></i>
                    </li>
                    <li >
                        <a href="">Process Admission</a>
                    </li>
                </ul>
            </div>
            ...
            ?>
                    ...
                    <div class="box ">
                            <div class="box-title">
                                <h3><i class="fa fa-child"></i>Process Admission</h3> 
                            </div>
                            <div class="box-content nopadding">                                
                                <form class='form-horizontal form-bordered' action="<?php echo base_url(); ?>index.php/Admissions/submit_admission" method="post" enctype="multipart/form-data"  >
                                    <input type="hidden" name="admiss_id" value="<?php echo $adms_id->adm_id ?>" />
                                        ...
                                        <div class="col-sm-4">
                                                <div class="form-group1" >
                                                    <label for="field-2" class="control-label">D.O.B<span style=" float: right ; color: red">*</span></label>                        
                                                                <input type="text" name="stddob" placeholder="Select Date Of Birth" id="stddob" class="form-control datepick" value="<?php
                                                                if(strlen($this->form->value('stddob'))>0){
                                                                    echo $this->form->value('stddob');
                                                                }else{
                                                                    echo date("d/m/Y",$adms_id->birthday);
                                                                } ?>">
                                                                <span style=" color: red">
                                                                    <?php
...
<?php
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <label for="textfield" class="control-label">Blood Group</label>
                                                 ...
                                                 <select name="stdbg" id="stdbg" class='select2-me' style="width:100%;" data-placeholder="Please select something">
                                                        <option value="" >Select Blood Group</option> 
                                                    <?php                                       
                                                    $blood_groups = unserialize (blood_groups);
                                                   foreach ($blood_groups as $key=>$value) {
                                                       ?>
                                                        <option  value="<?php echo $key ?>" <?php
                                                      if($this->form->value("stdbg")== $key){
                                                          echo "selected";
                                                      }
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group1" >
                                                    <label for="field-2" class="control-label">Student Mobile<span style=" float: right ; color: red">*</span></label>
                                                            <input type="text" maxlength="50" class="form-control" name="Mobile" placeholder="Enter Student Mobile No" value="<?php 
                                                            //phone
                                                                if(strlen($this->form->value('Mobile'))>0){
                                                                    echo  $this->form->value('Mobile');
                                                                }else{
                                                                  echo $adms_id->phone;
                                                                }
                                                              ?>" >
                                                ...
                                                <div class="form-group1" >
						<label for="field-2" class="control-label">Student E-mail</label>
							...
							<input type="text" class="form-control" name="email" value="<?php 
                                                        ...
                                                        echo $this->form->value('email') ?>" placeholder="Enter Student E-mail " >
						    <span style=" color: red">
                                                            <?php
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group1" >
                                                    <label for="field-2" class="control-label">Parent Mobile</label>
                                                            <input type="text" maxlength="50" class="form-control" name="prntmobile" placeholder="Enter Mobile No" value="<?php 
                                                            //phone
                                                                    echo  $this->form->value('prntmobile');
                                                                    
                                                              ?>" >
                                                                <span style=" color: red">
                                                                <?php
                                                                    echo $this->form->error('prntmobile');
                                                                ?>
                                                            </span>
                                                    </div>
                                                <div class="form-group1" >
						<label for="field-2" class="control-label">Parent E-mail<span style=" float: right ; color: red">*</span></label>
                        
							<input type="text" class="form-control" name="prntemail" value="<?php 
                                                           echo  $this->form->value('prntemail');
                                                        //         $this->form->value('email') ?>" placeholder="Enter Parent E-mail " >
						    <span style=" color: red">
                                                            <?php
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group2">
                                                    ...
                                                    if(strlen($this->form->value('stdaddress'))>0){
                                                                    echo  $this->form->value('stdaddress');
                                                                }else{
                                                                  echo $adms_id->address;
                                                                } ?></textarea>
                                                        <span style=" color: red">
                                                                <?php
                                            ...
                                            <div class="form-group1">
                                                ...
                                                <select style="width: 100%" class="select2-me" id="stdclass" name="stdclass" >
                                                            <option value="" >Class - Section</option>
                                                             <?php
            $query = " SELECT c.id,s.sid,s.name as sec_name , c.name as cls_name FROM `class` c JOIN section s ON s.class_id=c.id where c.iid='".$this->session->userdata('staff_Org_id')."' AND c.medium='".$md."' AND c.id='".$adms_id->class_id."'  ORDER BY c.id ";
						...
						<label for="field-2" class="control-label">Roll<span style=" float: right ; color: red">*</span></label>
                                    ...
                                    <div class="box"  style=" height: auto; padding-left: 15px;"  >
                                        ...
                                        <div class="col-sm-6 nopadding" style=" clear: both">
                                            <div class="form-group1">
                                                <label for="textfield" style=" padding-bottom: 5px;" class="control-label">Transfer Certificate<span style=" float: right ; color: red">*</span></label><br/>
                                            ...
                                            <div class="form-group1">
                                                <label for="textfield" style=" padding-bottom: 5px;" class="control-label">Caste Certificate<span style=" float: right ; color: red">*</span></label><br/>
                                     ...
                                     <div class="col-sm-6">
                                            ...
                                            <div class="form-group1">
                                                <label for="textfield" style=" padding-bottom: 5px;" class="control-label">Bonafide Certificate<span style=" float: right ; color: red">*</span></label><br/>
                                            ...
                                            <div class="form-group1">
                                                <label for="textfield" style=" padding-bottom: 5px;" class="control-label">Income Certificate<span style=" float: right ; color: red">*</span></label><br/>
