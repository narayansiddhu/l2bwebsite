...
<!--            <div class="col-sm-12" style=" margin-top: 5px; margin-bottom: 5px;">
            ...
            <div class="col-sm-12" style="margin-top: 5px; margin-bottom: 40px;">
                <a href="<?php echo base_url() ?>index.php/students/promote" class=" btn btn-primary" style=" width: 100%;  color: whitesmoke; text-align: center"><h4><i class="fa fa-graduation-cap fa-2x" aria-hidden="true"></i>&nbsp; Promote Student</h4></a>
            </div>
