...
<head>
    ...
    <title>L2B&Co. | Client Login </title>
    ...
    <div class="row">
        <div class="col-md-6 col-sm-6 col-md-offset-3 col-sm-offset-3 text-center">
            <div class="widget ibox-content"  style="margin-top: 1px;">
                ...
                <h3 class="no-margins">Client Login</h3>
                <form class="m-t" role="form" method="post" id="login_from" onsubmit="return onSubmit();">
                    ...
                    <div class="m-b-sm">
                        <a href="#">
                            ...
                            <a class="btn btn-sm btn-white btn-block" href="http://localhost/sal/client/index.php/registration.php">Create an account</a>
                        </a>
                    </div>
                </form>
