        ...
        <div class="box">
            ...
            <ul class="breadcrumb">
                ...
                <div class="box box-color box-bordered nopadding">
                    <div class="box-title">
                        <h3><i class="fa fa-calendar" aria-hidden="true"></i>View Exam Results</h3>
                    </div>
                    <div class="box-content nopadding">
                        <div class='form-horizontal form-bordered' >
                                    ...
                                    <div class="form-actions col-sm-offset-2 col-sm-10">
                                        <input type="button" disabled=""  id="fetch"  onclick="fetch_timetable();" value="Fetch Exam Results" class="btn btn-primary" />
             ...
             <script>
                 ...
                 function fetch_timetable(){
                     ...
                     if(count==0){
                         setState('result_holder','<?php echo base_url() ?>index.php/Students/fetch_exam_results','student='+student+'&exam='+exam);
                     }
