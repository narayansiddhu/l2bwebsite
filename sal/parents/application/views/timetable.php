        ...
        <div class="box">
           ...
           <ul class="breadcrumb">
                ...
                <div class="box box-color box-bordered nopadding">
                    <div class="box-title">
                        <h3><i class="fa fa-calendar" aria-hidden="true"></i>View Time Table</h3>
                    </div>
                    <div class="box-content nopadding">
                        <div class='form-horizontal form-bordered' >
                                    ...
                                    <div class="form-actions col-sm-offset-2 col-sm-10">
                                        <input type="button"  id="fetch"  onclick="fetch_timetable();" value="Fetch Time Table" class="btn btn-primary" />
                 ...
                 function fetch_timetable(){
                     ...
                     if(student.length==0){
                         $('#section_err').html("Please select Student");
                          ...
                          setState('result_holder','<?php echo base_url() ?>index.php/Students/ajax_timetable','student='+student);
                     }
                 }
             </script>
