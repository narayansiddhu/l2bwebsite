   ...
   <div class="col-sm-12"> 
       <div class="box"> 
            ...
            <ul>
                ...
                <li>
                    <a href="<?php echo base_url(); ?>index.php/">Manage Exams</a>
                     <i class="fa fa-angle-right" aria-hidden="true"></i>
                </li>
                <li>
    ...
    <?php 
    $sections=array();
    $query=$this->db->query("SELECT s.sid as secid,s.name as section, cl.name as class FROM  section s  JOIN class cl ON s.class_id=cl.id where s.iid='".$this->session->userdata('staff_id')."'");
    $query=$query->result();
    ...
    ?>
            ...
            <div class="box box-color box-bordered nopadding">
                    <div class="box-title">
                            <h3><i class="fa fa-bar-chart-o"></i>Select Class And Exam</h3>
                            <div class="actions">
