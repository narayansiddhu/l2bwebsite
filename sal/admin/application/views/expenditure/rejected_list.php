...
<div class="row">
    ...
    <div class="breadcrumbs">
        ...
        <div class="box box-bordered box-color">
                <div class="box-title">
                        <h3><i class="fa fa-th-list"></i>Expenses Rejected List</h3> 
                        <div class="actions">
                ...
                <div class="box-content nopadding"> 
                    <table class="table table-hover table-nomargin dataTable table-bordered" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" style="width: 100%;">
                        ...
                        <tbody>
                            <?php
                             $i=1;
                             $query=$this->db->query("SELECT e.*,s.name as staff FROM expenditure e JOIN staff s ON e.staff_id=s.id WHERE e.status =0 AND e.iid='".$this->session->userdata("staff_Org_id")."' ORDER BY e.time DESC ");
                             $query=$query->result();
                            ...
                            <tr>
                                ...
                                <td id="td_action_<?php echo $value->id  ?>">
                                   <?php   echo "Rejected On :".date('d-m-y',$value->approved_on); ?>
                                </td>
                            </tr>
                              <?php
                             }
