        ...
        <div class="box">
            <div class="breadcrumbs">
             ...
             <div class="box box-bordered box-color ">
                <div class="box-title">
                        <h3><i class="fa fa-comments-o" aria-hidden="true"></i>SMS Details</h3>
                </div>
                 <div class="box-content nopadding">
                     ...
                     <div class="row nopadding">
                         ...
                         <div class="col-sm-6 ">
                             <button onclick="send_alerts();" id="send_btn" style=" float: left" class="btn btn-primary">Send SMS&nbsp;&nbsp;<i class="fa fa-share"></i></button>
                         </div>
                     </div><br/>
                 </div>
             </div>
            ...
            <div id="action_name"></div>
             ...
             <div class="box box-bordered box-color ">
                <div class="box-title">
                        <h3><i class="fa fa-comments-o" aria-hidden="true"></i>SMS Preview</h3>
                </div>
                <div class="box-content nopadding">
